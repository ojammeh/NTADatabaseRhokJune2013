...
<?php echo $this->Form->create('Lecturer'); ?>
	<fieldset>
		<legend><?php echo __('Edit Lecturer'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Lecturer.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Lecturer.id'))); ?></li>
