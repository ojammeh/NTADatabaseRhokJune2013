...
<?php echo $this->Form->create('Attachmentlocation'); ?>
	<fieldset>
		<legend><?php echo __('Edit Attachmentlocation'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Attachmentlocation.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Attachmentlocation.id'))); ?></li>
